...
>(({ className, color = "blue", ...props }, ref) => {
  const activeClasses = {
    ...
    pink: [
      "data-[state=active]:bg-pink-500",
      "data-[state=active]:text-white",
      "data-[state=active]:ring-2 data-[state=active]:ring-pink-400",
      "data-[state=active]:shadow-md",
    ].join(" "),
    orange: [
      "data-[state=active]:bg-orange-500",
      "data-[state=active]:text-white",
      "data-[state=active]:ring-2 data-[state=active]:ring-orange-400",
      "data-[state=active]:shadow-md",
    ].join(" "),
    cyan: [
      "data-[state=active]:bg-teal-500",
      "data-[state=active]:text-white",
      "data-[state=active]:ring-2 data-[state=active]:ring-teal-400",
      "data-[state=active]:shadow-md",
    ].join(" "),
    green: [
